class Car(object):
    ...
    def __init__(self, xCoord, yCoord, length, direction, carID, color=0):
    ...
    def __str__(self):
        return "Coords: (%d, %d), len: %d, direction: %d" % (self.getXCoord(), self.getYCoord(), self.getLength(), self.getDirection())